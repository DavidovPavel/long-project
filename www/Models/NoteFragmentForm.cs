...
{
    /// <summary>
    /// Исходные данные при создании фрагмента пояснительной записки
    /// </summary>
    public class NoteFragmentForm
    {
        public NoteFragmentForm()
        {
        ...
        /// <summary>
        /// Вместе с фрагментом требуется создать факт
        /// </summary>
        public bool NeedCreateFact { get; set; }
    }
}