...
namespace www
{
    ...
    public class Transliteration
    {
        ...
        public string Front(string text, TransliterationType type)
        {
            ...
            output = tdict.Aggregate(output, (current, key) => current.Replace(key.Key, key.Value));
            if (ReplacemetSpaceChar != null)
                output = text.Replace(" ", ReplacemetSpaceChar);

            return output;
        }

        public string ReplacemetSpaceChar { get; set; }

        public string Back(string text)
        {
            string output = Back(text, TransliterationType.ISO);
            if (ReplacemetSpaceChar != null)
                output = text.Replace(ReplacemetSpaceChar, " ");
        ...
        public Transliteration(string replacemetSpaceChar)
        {
            ReplacemetSpaceChar = replacemetSpaceChar;
        }
