...
if (ej.RTE) ej.RTE.Locale["ru-RU"] = {
    ...
    unorderedList: "Создать маркированный список",
    orderedList: "Создать нумерованный список",
    indent: "Увеличить отступ",
    fileBrowser: "Обзор файлов",
    ...
    createLink: "Вставить / редактировать гиперссылку",
    removeLink: "Удалить гиперссылку",
    tableProperties: "Свойства таблицы",
    insertTable: "Вставить таблицу",
    deleteTables: "Удалить таблицу",
    imageProperties: "Свойства изображения",
    openLink: "Открыть гиперссылку",
    image: "Вставить изображение",
    video: "Вставить видео",
    editTable: "Изменить таблицу",
    embedVideo: "Вставить код",
    viewHtml: "Просмотр HTML",
    fontName: "Выберать семейство шрифтов",
    fontSize: "Выбрать размера шрифта",
    fontColor: "Выбрать цвета шрифта",
    format: "Форматирование",
    backgroundColor: "Фоновый цвет",
    style: "Стили",
    deleteAlert: "Вы уверены, что хотите удалить все содержимое?",
    copyAlert: "Ваш браузер не поддерживает прямой доступ к буферу обмена. Пожалуйста, используйте Ctrl + C вместо операции копирования.",
    pasteAlert: "Ваш браузер не поддерживает прямой доступ к буферу обмена. Пожалуйста, используйте Ctrl + V вместо операции вставки.",
    cutAlert: "Ваш браузер не поддерживает прямой доступ к буферу обмена. Пожалуйста, используйте  Ctrl + X вместо операции вырезания.",
    videoError: "Область текста не может быть пустой",
    imageWebUrl: "Ссылка на изображение",
    ...
    imageLink: "Изображение как ссылка",
    imageBorder: "Границы изображения",
    imageStyle: "Стиль",
    linkText: "Текст",
    linkTooltipLabel: "Подсказка",
    ...
    tableCellSpacing: "Растояние между ячейками",
    tableCellPadding: "Отступы в ячейке",
    tableBorder: "Рамка",
    ...
    addColumnRight: "Вставка столбцов справа",
    ...
    square: "Квадрат",
    number: "Число",
    loweralpha: "Строчные латинские буквы",
    upperalpha: "Заглавные латинские буквы",
    lowerroman: "Римские цифры в нижнем регистре",
    upperroman: "Римские цифры в верхнем регистре",
    none: "Нет",
    linkTooltip: "Нажмите Ctrl + клик, чтобы перейти по ссылке",
    charSpace: "Символы (с пробелами)",
    charNoSpace: "Символы (без пробелов)",
